    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            if (/^.*\/service\//g.test(req['_'].route.path.relative)) {
                services = req['_'].route.path.relative.replace(/^.*\/service\//g, '').split(':');
                discovery_1 = [];
                for (index = 0; index < services.length; index++) {
                    ...
                    services[index] == '' || services[index] == '/' ? null : discovery_1.push(services[index]);
                }
                req['_'].service.discovery = discovery_1;
            }
            next();
            return [2];
        });
