...
function distinct(collection, distinct, query, options) {
    return __awaiter(this, void 0, void 0, function () {
        var errorHandler, database, Model, select, sort, index, documents, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    documents = _a.sent();
                    res = documents.length == 0 ? null : JSON.parse(JSON.stringify(documents));
...
exports.default = callback(distinct);
