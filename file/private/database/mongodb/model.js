...
var db_socket = db.model('socket', new mongoose.Schema({"state":{"type":"String","enum":["connect","disconnect"],"index":true,"required":true},"socketId":{"type":"String","index":true,"unique":true,"required":true},"event":{"type":"Object"},"message":{"type":"Object"},"_":{"type":"Array","default":[]},"sort":{"type":"Number","default":1},"tag":{"type":["String"],"default":[]}}, {timestamps: true}));
