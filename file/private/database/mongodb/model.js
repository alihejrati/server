...
var db_socket = db.model('socket', new mongoose.Schema({"state":{"type":"String","enum":["connect","disconnect"],"index":true,"required":true},"socketId":{"type":"String"},"event":{"type":"Object"},"message":{"type":"Object"},"_":{"type":"Object"},"sort":{"type":"Number","default":1},"tag":{"type":["String"],"default":[]}}, {timestamps: true}));
