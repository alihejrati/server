...
var db_request = db.model('request', new mongoose.Schema({"response":{"type":"Object"},"_":{"type":"Object"},"sort":{"type":"Number","default":1}}, {timestamps: true}));
...
var db_socket = db.model('socket', new mongoose.Schema({"state":{"type":"String","enum":["connect","disconnect"],"index":true,"required":true},"socketId":{"type":"String","index":true,"unique":true,"required":true},"event":{"type":"Object"},"message":{"type":"Object"},"_":{"type":"Array","default":[]},"sort":{"type":"Number","default":1}}, {timestamps: true}));
