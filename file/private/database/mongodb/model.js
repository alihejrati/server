...
var db_socket = db.model('socket', new mongoose.Schema({"state":{"type":"String","enum":["connect","disconnect"],"index":true,"required":true},"socketId":{"type":"String","index":true,"unique":true,"required":true},"_":{"type":"Object","default":{}},"sort":{"type":"Number","default":1}}, {timestamps: true}));
