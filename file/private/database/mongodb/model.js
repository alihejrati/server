...
var db_captcha = db.model('captcha', new mongoose.Schema({"key":{"type":"String","index":true,"required":true},"value":{"type":"String","index":true,"required":true},"sort":{"type":"Number","default":1},"tag":{"type":["String"],"default":[]}}, {timestamps: true}));
var db_config = db.model('config', new mongoose.Schema({"key":{"type":"String","index":true,"unique":true,"required":true},"value":{"type":"Object","default":{}},"sort":{"type":"Number","default":1},"tag":{"type":["String"],"default":[]}}, {timestamps: true}));
var db_permission = db.model('permission', new mongoose.Schema({"label":"String","name":{"type":"String","index":true,"unique":true,"required":true},"sort":{"type":"Number","default":1},"tag":{"type":["String"],"default":[]}}, {timestamps: true}));
var db_request = db.model('request', new mongoose.Schema({"response":{"type":"Object"},"_":{"type":"Object"},"sort":{"type":"Number","default":1},"tag":{"type":["String"],"default":[]}}, {timestamps: true}));
var db_role = db.model('role', new mongoose.Schema({"label":"String","name":{"type":"String","index":true,"unique":true,"required":true},"permission":["ObjectId"],"sort":{"type":"Number","default":1},"tag":{"type":["String"],"default":[]}}, {timestamps: true}));
var db_socket = db.model('socket', new mongoose.Schema({"state":{"type":"String","enum":["connect","disconnect"],"index":true,"required":true},"socketId":{"type":"String","index":true,"required":true},"event":{"type":"Object"},"message":{"type":"Object"},"_":{"type":"Object"},"sort":{"type":"Number","default":1},"tag":{"type":["String"],"default":[]}}, {timestamps: true}));
var db_stack = db.model('stack', new mongoose.Schema({"stack":{"type":"Array","default":[]},"sort":{"type":"Number","default":1},"tag":{"type":["String"],"default":[]}}, {timestamps: true}));
