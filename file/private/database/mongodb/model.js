...
var db_table = db.model('table', new mongoose.Schema({"category":{"type":"String"},"name":{"type":"String","required":true,"unique":true},"label":{"type":"String"},"description":{"type":"String"},"pagetitle":{"type":"String"},"columns":{"type":"Object","required":true},"buttons":{"type":"Object","required":true,"default":{"copy":{"extend":"copy","text":"copy","html":{"title":"رونوشت"}},"csv":{"extend":"csv","text":"csv","html":{"title":"لیست"}},"excel":{"extend":"excel","text":"excel","html":{"title":"اکسل"}},"pdf":{"extend":"pdf","text":"pdf","html":{"title":"کتاب الکترونیک"}},"print":{"extend":"print","text":"print","html":{"title":"چاپ"}}}},"service":{"type":"Object"},"sort":{"type":"Number","default":1},"tag":{"type":["String"],"default":[]},"flag":{"type":"Object","default":{"hide":false}}}, {timestamps: true}));
...
(async () => {
    ...
    const value = JSON.parse(JSON.stringify(document));
    const seed = [{"category":"","name":"tables","label":"جداول","description":"گزارش گیری از جدول های منطقی","pagetitle":"","columns":{"tools":{"title":"ابزارها","data":"tools","defaultContent":"del:edit:check","orderable":false,"visible":true,"html":{"title":"حذف:ویرایش:انتخاب"}},"_id":{"title":"شناسه ها","data":"_id","defaultContent":"یافت نشد","orderable":false,"visible":false,"html":{"title":"قابلیت مرتب سازی ندارد"}},"description":{"title":"توضیحات","data":"description","defaultContent":"یافت نشد","orderable":false,"visible":true,"html":{"title":"قابلیت مرتب سازی ندارد"}},"label":{"title":"برچسب","data":"label","defaultContent":"یافت نشد","orderable":true,"visible":true,"html":{"title":"مرتب سازی براساس برچسب"}},"name":{"title":"نام","data":"name","defaultContent":"یافت نشد","orderable":true,"visible":true,"html":{"title":"مرتب سازی براساس نام"}}},"service":{"read":{"server":"http","route":"/service/crud/read"},"del":{"server":"http","route":"/service/crud/delete"},"edit":{"server":"http","route":"/service/crud/update"}}}];
    if (!value) {
        const database = 'db';
