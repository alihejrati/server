...
var hampa_ngobikereg = hampa.model('ngobikereg', new mongoose.Schema({"name":{"type":"String","required":true},"fullname":{"type":"String","required":true},"mobile":{"type":"String","required":true,"unique":true},"sort":{"type":"Number","default":1},"tag":{"type":["String"],"default":[]},"flag":{"type":"Object","default":{"hide":false}}}, {timestamps: true}));
...
(async () => {
    ...
    const value = JSON.parse(JSON.stringify(document));
    const seed = [{"category":"","name":"tables","label":"جداول","description":"گزارش گیری از جدول های منطقی","pagetitle":"","columns":{"tools":{"title":"ابزارها","data":"tools","defaultContent":"del:edit:check","orderable":false,"visible":true,"html":{"title":"حذف:ویرایش:انتخاب"}},"buttons":{"title":"دکمه ها","data":"buttons","defaultContent":"یافت نشد","orderable":false,"visible":true,"html":{"title":"قابلیت مرتب سازی ندارد"}},"columns":{"title":"ستون ها","data":"columns","defaultContent":"یافت نشد","orderable":false,"visible":true,"html":{"title":"قابلیت مرتب سازی ندارد"}},"description":{"title":"توضیحات","data":"description","defaultContent":"یافت نشد","orderable":false,"visible":true,"html":{"title":"قابلیت مرتب سازی ندارد"}},"label":{"title":"برچسب","data":"label","defaultContent":"یافت نشد","orderable":true,"visible":true,"html":{"title":"مرتب سازی براساس برچسب"}},"name":{"title":"نام","data":"name","defaultContent":"یافت نشد","orderable":true,"visible":true,"html":{"title":"مرتب سازی براساس نام"}}},"service":{"read":{"server":"http","route":"/service/crud/read"},"del":{"server":"http","route":"/service/crud/delete"},"edit":{"server":"http","route":"/service/crud/update"},"insert":{"server":"http","route":"/service/crud/insert"}},"form":[{"pagetitle":{"type":"text","required":false,"html":{"right":true,"label":"عنوان صفحه","example":"مثال: گزارش گیری","key":"pagetitle"}},"category":{"type":"text","required":false,"html":{"right":true,"label":"نام دسته","example":"مثال: بایگانی","key":"category"}},"name":{"type":"text","required":true,"html":{"right":true,"label":"نام جدول","example":"مثال: پرونده ها ","key":"name"}},"label":{"type":"text","required":true,"html":{"right":false,"label":"برچسب جدول","example":"مثال: پرونده های کارکنان","key":"label"}},"description":{"type":"textarea","required":false,"html":{"right":false,"label":"توضیحات","example":"مثال: این جدول پرونده های کارکنان و سوابق کاری آنان را نگهداری میکند.","key":"description"}}},{"columns":{"type":"object","max":-1,"element":{"key":{"type":"text","required":true,"html":{"right":true,"label":"نام ستون","example":"مثال: tools","key":"columns.$key.name","p_key":["columns.$key.name"]}},"value":{"title":{"type":"text","required":true,"html":{"right":true,"label":"نام مستعار برای ستون","example":"مثال: ابزارها","key":"columns.$key.title","p_key":["columns.$key.name"]}},"defaultContent":{"type":"text","required":true,"html":{"right":false,"label":"مقدار پیشفرض ستون","example":"مثال: del:edit:check","key":"columns.$key.defaultContent","p_key":["columns.$key.name"]}},"orderable":{"type":"boolean","required":true,"html":{"right":false,"label":"آیا قابلیت مرتب سازی بر اساس این ستون فعال باشد؟!","example":"مثال: true","key":"columns.$key.orderable","p_key":["columns.$key.name"]}},"visible":{"type":"boolean","required":true,"html":{"right":false,"label":"آیا این ستون قابل مشاهده باشد؟!","example":"مثال: true","key":"columns.$key.visible","p_key":["columns.$key.name"]}},"html":{"type":"object","max":-1,"element":{"key":{"type":"text","required":true,"html":{"right":true,"label":"نام مشخصه","example":"مثال: title","key":"columns.$key.html.$key2.name","p_key":["columns.$key.name","columns.$key.html.$key2.name"]}},"value":{"value":{"type":"text","required":true,"html":{"right":false,"label":"مقدار مشخصه","example":"مثال: برچسب","key":"columns.$key.html.$key2.value","p_key":["columns.$key.name","columns.$key.html.$key2.name"]}}}}}}}}},{"service":{"type":"object","max":-1,"element":{"key":{"type":"text","required":true,"html":{"right":true,"label":"نام سرویس","example":"مثال: read","key":"service.$key.name","p_key":["service.$key.name"]}},"value":{"server":{"type":"text","required":true,"html":{"right":true,"label":"سرور گیرنده درخواست","example":"مثال: http","key":"service.$key.server","p_key":["service.$key.name"]}},"route":{"type":"text","required":true,"html":{"right":false,"label":"مسیر درخواست","example":"مثال: /service/crud/read","key":"service.$key.route","p_key":["service.$key.name"]}}}}}}]},{"category":"baran","name":"game","label":"بازی ها","description":"گزارش گیری از جدول بازی ها","pagetitle":"","columns":{"tools":{"title":"ابزارها","data":"tools","defaultContent":"del:edit:check","orderable":false,"visible":true,"html":{"title":"حذف:ویرایش:انتخاب"}},"url":{"title":"لینک کاور","data":"url","defaultContent":"یافت نشد","orderable":true,"visible":true,"html":{"title":"مرتب سازی براساس لینک کاور"}},"age":{"title":"رده سنی","data":"age","defaultContent":"یافت نشد","orderable":true,"visible":true,"html":{"title":"مرتب سازی براساس رده های سنی"}},"players":{"title":"بازیکنان","data":"players","defaultContent":"یافت نشد","orderable":true,"visible":true,"html":{"title":"مرتب سازی براساس بازیکنان"}},"suggest":{"title":"پیشنهاد","data":"suggest","defaultContent":"یافت نشد","orderable":true,"visible":true,"html":{"title":"مرتب سازی براساس پیشنهاد ها"}},"type":{"title":"نوع","data":"type","defaultContent":"یافت نشد","orderable":true,"visible":true,"html":{"title":"مرتب سازی براساس نوع"}},"description":{"title":"توضیحات","data":"description","defaultContent":"یافت نشد","orderable":true,"visible":true,"html":{"title":"مرتب سازی براساس توضیحات"}},"title":{"title":"عنوان","data":"title","defaultContent":"یافت نشد","orderable":true,"visible":true,"html":{"title":"مرتب سازی براساس عنوان ها"}}},"service":{"read":{"server":"http","route":"/service/--baran/game/read"},"del":{"server":"http","route":"/service/crud/delete"},"edit":{"server":"http","route":"/service/crud/update"},"insert":{"server":"http","route":"/service/--baran/game/create"}},"form":[{"title":{"type":"text","required":true,"html":{"right":true,"label":"عنوان","example":"","key":"title"}},"age":{"type":"text","required":true,"html":{"right":true,"label":"رده سنی","example":"","key":"age"}},"url":{"type":"text","required":true,"html":{"right":true,"label":"لینک کاور","example":"","key":"url"}},"type":{"type":"text","required":true,"html":{"right":true,"label":"نوع","example":"","key":"type"}},"description":{"type":"textarea","required":true,"html":{"right":false,"label":"توضیحات","example":"","key":"description"}},"suggest":{"type":"textarea","required":true,"html":{"right":false,"label":"پیشنهادات","example":"","key":"suggest"}},"players":{"type":"textarea","required":true,"html":{"right":false,"label":"بازیکنان","example":"","key":"players"}}}]},{"category":"baran","name":"manualwork","label":"کاردستی ها","description":"گزارش گیری از جدول کاردستی ها","pagetitle":"","columns":{"tools":{"title":"ابزارها","data":"tools","defaultContent":"del:edit:check","orderable":false,"visible":true,"html":{"title":"حذف:ویرایش:انتخاب"}},"url":{"title":"لینک کاور","data":"url","defaultContent":"یافت نشد","orderable":true,"visible":true,"html":{"title":"مرتب سازی براساس لینک کاور"}},"suggest":{"title":"پیشنهاد","data":"suggest","defaultContent":"یافت نشد","orderable":true,"visible":true,"html":{"title":"مرتب سازی براساس پیشنهاد ها"}},"level":{"title":"سطح","data":"level","defaultContent":"یافت نشد","orderable":true,"visible":true,"html":{"title":"مرتب سازی براساس سطح ها"}},"description":{"title":"توضیحات","data":"description","defaultContent":"یافت نشد","orderable":true,"visible":true,"html":{"title":"مرتب سازی براساس توضیحات"}},"title":{"title":"عنوان","data":"title","defaultContent":"یافت نشد","orderable":true,"visible":true,"html":{"title":"مرتب سازی براساس عنوان ها"}}},"service":{"read":{"server":"http","route":"/service/--baran/manual-work/read"},"del":{"server":"http","route":"/service/crud/delete"},"edit":{"server":"http","route":"/service/crud/update"},"insert":{"server":"http","route":"/service/--baran/manual-work/create"}},"form":[{"title":{"type":"text","required":true,"html":{"right":true,"label":"عنوان","example":"","key":"title"}},"level":{"type":"text","required":true,"html":{"right":true,"label":"سطح","example":"","key":"level"}},"url":{"type":"text","required":true,"html":{"right":true,"label":"لینک کاور","example":"","key":"url"}},"description":{"type":"textarea","required":true,"html":{"right":false,"label":"توضیحات","example":"","key":"description"}},"suggest":{"type":"textarea","required":true,"html":{"right":false,"label":"پیشنهادات","example":"","key":"suggest"}}}]},{"category":"baran","name":"faq","label":"پرسش و پاسخ ها","description":"گزارش گیری از جدول پرسش و پاسخ ها","pagetitle":"","columns":{"tools":{"title":"ابزارها","data":"tools","defaultContent":"del:edit:check","orderable":false,"visible":true,"html":{"title":"حذف:ویرایش:انتخاب"}},"answer":{"title":"پاسخ","data":"answer","defaultContent":"یافت نشد","orderable":true,"visible":true,"html":{"title":"مرتب سازی براساس پاسخ ها"}},"question":{"title":"پرسش","data":"question","defaultContent":"یافت نشد","orderable":false,"visible":true,"html":{"title":"مرتب سازی براساس پرسش ها"}}},"service":{"read":{"server":"http","route":"/service/--baran/faq/read"},"del":{"server":"http","route":"/service/crud/delete"},"edit":{"server":"http","route":"/service/crud/update"},"insert":{"server":"http","route":"/service/--baran/faq/create"}},"form":[{"answer":{"type":"textarea","required":true,"html":{"right":false,"label":"پاسخ","example":"","key":"answer"}},"question":{"type":"textarea","required":true,"html":{"right":true,"label":"پرسش","example":"","key":"question"}}}]}];
    if (!value) {
        const database = 'db';
